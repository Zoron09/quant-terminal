...
from utils.code33_engine import _get_fq_fy, _build_margin_pool, _date_first_yoy, get_code33_data, _c33_status
...
def get_edgar_financials(ticker: str, cache_v: str = CACHE_VERSION) -> dict:
...
def fetch_stock_news(ticker: str, cache_v: str = CACHE_VERSION) -> list:
...
def get_analyst_estimates(ticker: str, cache_v: str = CACHE_VERSION) -> dict:
...
with tab4:
    ...
    if st.button("Force Refresh Code 33 Data"):
        get_code33_data.clear(ticker)
        st.rerun()
